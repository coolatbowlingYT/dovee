...
var use = message.mentions.users.first();
  ...
  .addField(`**Status:**`, `${mem.status}`)
	...
	//.addField(`**Highest role:**`, `${mem.highestRole.position}`)
  ...
  .addField(`**Device:**`, `${message.member.presence.clientStatus}`)
	...
	//.addField(`**Highest role:**`, `${message.member.highestRole.position}`)
